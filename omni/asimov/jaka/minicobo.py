...
class Minicobo(Robot):
    ...
    Args:
        ...
        name (str, optional): [description]. Defaults to "minicobo".
    ...
    def __init__(
        ...
        if not prim.IsValid():
            if usd_path:
                ...
                assets_root_path = get_extension_path_from_name("omni.asimov.jaka")
                if assets_root_path is None:
                    carb.log_error("Could not find Isaac Sim assets folder")
                usd_path = assets_root_path + "/usd/jaka-bare.usd"
                add_reference_to_stage(usd_path=usd_path, prim_path=prim_path)
